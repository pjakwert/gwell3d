...
**
** Created: Mon Oct 11 20:23:54 2004
...
QMetaObject* Table::staticMetaObject()
{
    ...
    static const QUMethod slot_1 = {"removeCurrentRow", 0, 0 };
    static const QUParameter param_slot_2[] = {
	{ "value", &static_QUType_double, 0, QUParameter::In }
    };
    static const QUMethod slot_2 = {"setCurrentValue", 1, param_slot_2 };
    static const QUParameter param_slot_3[] = {
	{ "controlItem", &static_QUType_ptr, "ViKinemCtrlItem", QUParameter::In }
    };
    static const QUMethod slot_3 = {"updateItem", 1, param_slot_3 };
    static const QUParameter param_slot_4[] = {
	{ 0, &static_QUType_bool, 0, QUParameter::Out },
	{ "row", &static_QUType_int, 0, QUParameter::In },
	{ "col", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_4 = {"validateAndSet", 3, param_slot_4 };
    static const QUParameter param_slot_5[] = {
	{ 0, &static_QUType_int, 0, QUParameter::In },
	{ 0, &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_5 = {"rowAndColChanged", 2, param_slot_5 };
    static const QMetaData slot_tbl[] = {
	{ "addRow(ViKinemCtrlItem*)", &slot_0, QMetaData::Public },
	{ "removeCurrentRow()", &slot_1, QMetaData::Public },
	{ "setCurrentValue(double)", &slot_2, QMetaData::Public },
	{ "updateItem(ViKinemCtrlItem*)", &slot_3, QMetaData::Public },
	{ "validateAndSet(int,int)", &slot_4, QMetaData::Private },
	{ "rowAndColChanged(int,int)", &slot_5, QMetaData::Private }
    };
...
bool Table::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 1: removeCurrentRow(); break;
    case 2: setCurrentValue((double)static_QUType_double.get(_o+1)); break;
    case 3: updateItem((ViKinemCtrlItem*)static_QUType_ptr.get(_o+1)); break;
    case 4: static_QUType_bool.set(_o,validateAndSet((int)static_QUType_int.get(_o+1),(int)static_QUType_int.get(_o+2))); break;
    case 5: rowAndColChanged((int)static_QUType_int.get(_o+1),(int)static_QUType_int.get(_o+2)); break;
    default:
