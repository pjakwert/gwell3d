...
**
** Created: Fri Oct 8 13:52:24 2004
...
QMetaObject* ModifyWidget::staticMetaObject()
{
    ...
    static const QUMethod slot_8 = {"setCoordsTrans", 0, 0 };
    static const QUMethod slot_9 = {"setCoordsRot", 0, 0 };
    static const QUParameter param_slot_10[] = {
	{ "mType", &static_QUType_ptr, "MModifier::ModifierType", QUParameter::In },
	{ "v", &static_QUType_ptr, "Vector3f", QUParameter::In }
    };
    static const QUMethod slot_10 = {"updateData", 2, param_slot_10 };
    static const QUParameter param_slot_11[] = {
	{ "yes", &static_QUType_bool, 0, QUParameter::In }
    };
    static const QUMethod slot_11 = {"enableInput", 1, param_slot_11 };
    static const QUParameter param_slot_12[] = {
	{ 0, &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_12 = {"primitiveTypeChanged", 1, param_slot_12 };
    static const QUMethod slot_13 = {"setDefaultModifier", 0, 0 };
    ...
    static const QUMethod slot_15 = {"setSelected", 1, param_slot_15 };
    static const QUParameter param_slot_16[] = {
	{ "primitiveList", &static_QUType_varptr, "\x04", QUParameter::In }
    };
    static const QUMethod slot_16 = {"setPrimitiveList", 1, param_slot_16 };
	...
	{ "setCoordsTrans()", &slot_8, QMetaData::Private },
	{ "setCoordsRot()", &slot_9, QMetaData::Private },
	{ "updateData(MModifier::ModifierType,Vector3f)", &slot_10, QMetaData::Private },
	{ "enableInput(bool)", &slot_11, QMetaData::Private },
	{ "primitiveTypeChanged(int)", &slot_12, QMetaData::Private },
	{ "setDefaultModifier()", &slot_13, QMetaData::Public },
	{ "setModifier(MModifier::ModifierType)", &slot_14, QMetaData::Public },
	{ "setSelected(QPtrList<ViNTreeNode>*)", &slot_15, QMetaData::Public },
	{ "setPrimitiveList(QStringList*)", &slot_16, QMetaData::Public }
    };
...
bool ModifyWidget::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 8: setCoordsTrans(); break;
    case 9: setCoordsRot(); break;
    case 10: updateData((MModifier::ModifierType)(*((MModifier::ModifierType*)static_QUType_ptr.get(_o+1))),(Vector3f)(*((Vector3f*)static_QUType_ptr.get(_o+2)))); break;
    case 11: enableInput((bool)static_QUType_bool.get(_o+1)); break;
    case 12: primitiveTypeChanged((int)static_QUType_int.get(_o+1)); break;
    case 13: setDefaultModifier(); break;
    case 14: setModifier((MModifier::ModifierType)(*((MModifier::ModifierType*)static_QUType_ptr.get(_o+1)))); break;
    case 15: setSelected((QPtrList<ViNTreeNode>*)static_QUType_ptr.get(_o+1)); break;
    case 16: setPrimitiveList((QStringList*)static_QUType_varptr.get(_o+1)); break;
    default:
