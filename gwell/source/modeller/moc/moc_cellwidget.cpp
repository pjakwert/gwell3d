...
**
** Created: Fri Oct 8 13:45:38 2004
...
QMetaObject* CellWidget::staticMetaObject()
{
    ...
    static const QUMethod slot_6 = {"lightsToggled", 1, param_slot_6 };
    static const QUParameter param_slot_7[] = {
	{ "direction", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_7 = {"viewDirChanged", 1, param_slot_7 };
    static const QUParameter param_slot_8[] = {
	{ "viewType", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_8 = {"viewTypeChanged", 1, param_slot_8 };
    static const QUParameter param_slot_9[] = {
	{ "viewProj", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_9 = {"viewProjChanged", 1, param_slot_9 };
    static const QUMethod slot_10 = {"screenshotClicked", 0, 0 };
    static const QUMethod slot_11 = {"maximizeClicked", 0, 0 };
	...
	{ "lightsToggled(bool)", &slot_6, QMetaData::Private },
	{ "viewDirChanged(int)", &slot_7, QMetaData::Private },
	{ "viewTypeChanged(int)", &slot_8, QMetaData::Private },
	{ "viewProjChanged(int)", &slot_9, QMetaData::Private },
	{ "screenshotClicked()", &slot_10, QMetaData::Private },
	{ "maximizeClicked()", &slot_11, QMetaData::Private }
    };
    ...
    static const QUMethod signal_4 = {"showLights", 1, param_signal_4 };
    static const QUParameter param_signal_5[] = {
	{ "direction", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod signal_5 = {"viewDirectionChanged", 1, param_signal_5 };
    static const QUParameter param_signal_6[] = {
	{ "type", &static_QUType_ptr, "DrawMethod", QUParameter::In }
    };
    static const QUMethod signal_6 = {"setViewType", 1, param_signal_6 };
    static const QUParameter param_signal_7[] = {
	{ "type", &static_QUType_ptr, "qglviewer::Camera::Type", QUParameter::In }
    };
    static const QUMethod signal_7 = {"setProjType", 1, param_signal_7 };
    static const QUMethod signal_8 = {"makeScreenshot", 0, 0 };
    static const QUMethod signal_9 = {"maximize", 0, 0 };
	...
	{ "showLights(bool)", &signal_4, QMetaData::Private },
	{ "viewDirectionChanged(int)", &signal_5, QMetaData::Private },
	{ "setViewType(DrawMethod)", &signal_6, QMetaData::Private },
	{ "setProjType(qglviewer::Camera::Type)", &signal_7, QMetaData::Private },
	{ "makeScreenshot()", &signal_8, QMetaData::Private },
	{ "maximize()", &signal_9, QMetaData::Private }
    };
...
bool CellWidget::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 6: lightsToggled((bool)static_QUType_bool.get(_o+1)); break;
    case 7: viewDirChanged((int)static_QUType_int.get(_o+1)); break;
    case 8: viewTypeChanged((int)static_QUType_int.get(_o+1)); break;
    case 9: viewProjChanged((int)static_QUType_int.get(_o+1)); break;
    case 10: screenshotClicked(); break;
    case 11: maximizeClicked(); break;
    default:
...
bool CellWidget::qt_emit( int _id, QUObject* _o )
{
    ...
    case 4: showLights((bool)static_QUType_bool.get(_o+1)); break;
    case 5: viewDirectionChanged((int)static_QUType_int.get(_o+1)); break;
    case 6: setViewType((DrawMethod)(*((DrawMethod*)static_QUType_ptr.get(_o+1)))); break;
    case 7: setProjType((qglviewer::Camera::Type)(*((qglviewer::Camera::Type*)static_QUType_ptr.get(_o+1)))); break;
    case 8: makeScreenshot(); break;
    case 9: maximize(); break;
    default:
