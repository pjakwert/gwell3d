...
class Workspace : public QWidget
{
  ...
  private slots:
    void userSelected( QPtrList<ViMultiPolyh> *selected ); // wybrane w CellFrame - podaj dalej
  ...
  public slots:
    ...
    void setSelected( QPtrList<ViMultiPolyh> *selected );  // rozdaj CellFrame-om wybrane obiekty
  ...
  signals:
    ...
    void userSelectedObject( QPtrList<ViMultiPolyh> *selected );
};
