...
class MModifier : public QObject
{
  ...
  public:
    enum ModifierType { M_SELECT = 0, M_TRANSLATE, M_ROTATE, M_SCALE, M_LINK, M_TRANSLIGHTPOS, M_TRANSLIGHTDIR };
    ...
    virtual void mousePressEvent( QMouseEvent *e, qglviewer::Camera *camera, QPtrList<ViMultiPolyh> *selectedList ) {}
