...
**
** Created: Wed Oct 13 20:04:11 2004
...
QMetaObject* LightsTableWidget::staticMetaObject()
{
    ...
    static const QUMethod slot_3 = {"addLight", 1, param_slot_3 };
    static const QUMethod slot_4 = {"deleteLight", 0, 0 };
    static const QUMethod slot_5 = {"deleteAllLights", 0, 0 };
    static const QUParameter param_slot_6[] = {
	{ 0, &static_QUType_bool, 0, QUParameter::In }
    };
    static const QUMethod slot_6 = {"toggleLight", 1, param_slot_6 };
    static const QUParameter param_slot_7[] = {
	{ 0, &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_7 = {"bulbOrSpotChanged", 1, param_slot_7 };
    static const QUParameter param_slot_8[] = {
	{ 0, &static_QUType_int, 0, QUParameter::In },
	{ 0, &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_8 = {"currentLightChanged", 2, param_slot_8 };
    static const QUParameter param_slot_9[] = {
	{ 0, &static_QUType_int, 0, QUParameter::In },
	{ 0, &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_9 = {"userChangedName", 2, param_slot_9 };
	...
	{ "addLight(Light*)", &slot_3, QMetaData::Public },
	{ "deleteLight()", &slot_4, QMetaData::Public },
	{ "deleteAllLights()", &slot_5, QMetaData::Public },
	{ "toggleLight(bool)", &slot_6, QMetaData::Private },
	{ "bulbOrSpotChanged(int)", &slot_7, QMetaData::Private },
	{ "currentLightChanged(int,int)", &slot_8, QMetaData::Private },
	{ "userChangedName(int,int)", &slot_9, QMetaData::Private }
    };
...
bool LightsTableWidget::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 3: addLight((Light*)static_QUType_ptr.get(_o+1)); break;
    case 4: deleteLight(); break;
    case 5: deleteAllLights(); break;
    case 6: toggleLight((bool)static_QUType_bool.get(_o+1)); break;
    case 7: bulbOrSpotChanged((int)static_QUType_int.get(_o+1)); break;
    case 8: currentLightChanged((int)static_QUType_int.get(_o+1),(int)static_QUType_int.get(_o+2)); break;
    case 9: userChangedName((int)static_QUType_int.get(_o+1),(int)static_QUType_int.get(_o+2)); break;
    default:
