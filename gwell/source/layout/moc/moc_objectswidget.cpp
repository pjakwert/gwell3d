...
**
** Created: Wed Oct 13 20:04:51 2004
...
QMetaObject* ObjectsWidget::staticMetaObject()
{
    ...
    static const QUMethod slot_0 = {"buildList", 0, 0 };
    static const QUMethod slot_1 = {"expandAll", 0, 0 };
    static const QUMethod slot_2 = {"collapseAll", 0, 0 };
	...
	{ "buildList()", &slot_0, QMetaData::Private },
	{ "expandAll()", &slot_1, QMetaData::Private },
	{ "collapseAll()", &slot_2, QMetaData::Private },
	...
	{ "setSelectedList(QPtrList<ViMultiPolyh>*)", &slot_6, QMetaData::Public },
	{ "setRoot(ViScene*)", &slot_7, QMetaData::Public },
	...
	{ "selectionChanged(QPtrList<ViMultiPolyh>*)", &signal_0, QMetaData::Public }
    };
...
void ObjectsWidget::selectionChanged( QPtrList<ViMultiPolyh>* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool ObjectsWidget::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 0: buildList(); break;
    case 1: expandAll(); break;
    case 2: collapseAll(); break;
    ...
    case 6: setSelectedList((QPtrList<ViMultiPolyh>*)static_QUType_ptr.get(_o+1)); break;
    case 7: setRoot((ViScene*)static_QUType_ptr.get(_o+1)); break;
    case 8: update(); break;
    default:
...
bool ObjectsWidget::qt_emit( int _id, QUObject* _o )
{
    ...
    case 0: selectionChanged((QPtrList<ViMultiPolyh>*)static_QUType_ptr.get(_o+1)); break;
    default:
