...
**
** Created: Wed Oct 13 20:03:21 2004
...
QMetaObject* DrawWidget::staticMetaObject()
{
    ...
    static const QUMethod slot_1 = {"setScene", 1, param_slot_1 };
    static const QMetaData slot_tbl[] = {
	{ "multiPolyhSelected(const char*)", &slot_0, QMetaData::Private },
	{ "setScene(ViScene*)", &slot_1, QMetaData::Public }
    };
    static const QUParameter param_signal_0[] = {
	{ "mphPath", &static_QUType_charstar, 0, QUParameter::In }
    };
    static const QUMethod signal_0 = {"addMultiPolyh", 1, param_signal_0 };
    static const QMetaData signal_tbl[] = {
	{ "addMultiPolyh(const char*)", &signal_0, QMetaData::Public }
    };
...
void DrawWidget::addMultiPolyh( const char* t0 )
{
    if ( signalsBlocked() )
	return;
...
bool DrawWidget::qt_emit( int _id, QUObject* _o )
{
    ...
    case 0: addMultiPolyh((const char*)static_QUType_charstar.get(_o+1)); break;
    default:
