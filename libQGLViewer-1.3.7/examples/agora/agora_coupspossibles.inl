...
template<class Ints>
inline bool Agora<Ints>::calcule_poss_dessous_noir(const bool c, const Hauteur_t t)  const {
//     return ( !c && t );
    return ( !c );
}
...
template<class Ints>
inline bool Agora<Ints>::calcule_poss_dessous_blanc(const bool c, const Hauteur_t t)  const {
//     return ( c && t);
    return c;
}
